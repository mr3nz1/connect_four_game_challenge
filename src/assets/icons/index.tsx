...
function Facebook({ color }: { color: string }) {
  return (
...
function YouTube({ color }: { color: string }) {
  return (
...
function Twitter({ color }: { color: string }) {
  return (
...
function Pinterest({ color }: { color: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
      <defs>
        <linearGradient id="a" x1="100%" x2="0%" y1="0%" y2="100%">
...
function Instagram({ color }: { color: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20">
      <defs>
